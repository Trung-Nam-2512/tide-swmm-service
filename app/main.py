...
# Include routers with swmm-api prefix
app.include_router(swmm.swmm_router)
app.include_router(forecast.forecast_router, prefix="/swmm-api")
app.include_router(nodes.nodes_router, prefix="/swmm-api")
